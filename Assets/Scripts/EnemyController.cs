...
public class EnemyController : MonoBehaviour
{
    ...
    private float enterRoomTime = 0.5f;
    ...
    void Update()
    {
        if(enterRoomTime <= 0f && theBody.isVisible && PlayerController.instance.gameObject.activeInHierarchy)
        {
    ...
    private void OnCollisionEnter2D(Collision2D other)
    {
        ...
        if (other.gameObject.tag == "Player" && !PlayerController.instance.IsDashing())
        {
